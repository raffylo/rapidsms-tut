# Django settings for rapidsms_tut_vote project.

import os

# The top directory for this project. Contains requirements/, manage.py,
# and README.rst, a rapidsms_tut_vote directory with settings etc (see
...
PROJECT_PATH = os.path.join(PROJECT_ROOT, 'rapidsms_tut_vote')
...
SECRET_KEY = 'v$kdzw2$p!s3g)o_aeoe!n40vte&-javok@_i(^3v)2p9x*0m+'
...
ROOT_URLCONF = 'rapidsms_tut_vote.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'rapidsms_tut_vote.wsgi.application'
